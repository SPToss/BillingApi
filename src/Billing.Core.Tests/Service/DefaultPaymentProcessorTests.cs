...
{
    public class DefaultPaymentProcessorTests : IDisposable
    {
        ...
        public DefaultPaymentProcessorTests()
        {
            ...
            _sut = new DefaultPaymentProcessor(_discountFactoryMock.Object, _mapperMock.Object);
        }
        ...
        public async Task ProcessOrder_WhenCorrectOrder_ShouldProcessOrder()
        {
            ...
            await Assert.ThrowsAsync<PaymentValidationException>(async () => await _sut.ProcessOrder(oder));
