...
{
    public class GooglePayPaymentProcessorTests : IDisposable
    {
        ...
        public GooglePayPaymentProcessorTests()
        {
            ...
            _sut = new GooglePayPaymentProcessor(_discountFactoryMock.Object, _mapperMock.Object);
        }
