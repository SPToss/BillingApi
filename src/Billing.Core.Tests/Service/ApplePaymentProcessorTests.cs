...
{
    public class ApplePaymentProcessorTests : IDisposable
    {
        ...
        public ApplePaymentProcessorTests()
        {
            ...
            _sut = new ApplePayPaymentProcessor(_discountFactoryMock.Object, _mapperMock.Object);
        }
